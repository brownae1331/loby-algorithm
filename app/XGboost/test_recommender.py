...
def generate_swipe_history(profiles):
    ...
    for i, viewer_profile in enumerate(profiles):
        for j, swiped_profile in enumerate(profiles):
            if i != j:
                score = xgb_func.calculate_overall_score(viewer_profile, swiped_profile)
