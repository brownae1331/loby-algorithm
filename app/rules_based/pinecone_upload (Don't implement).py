...
def upload_profiles_to_pinecone():
    ...
    # Initialize Pinecone
    PINECONE_API_KEY = (
        "pcsk_65UBva_G8bL9ADx5Ea72DM8jTcirezWayGDHkHAi4eY3YBHXbN43tHpnfdUhUgzEbTwAKr"
    )
    ...
    profile_list: List[Profile] = assign_profiles_to_profile_list(
        starting_profile, profile_objects
    )
    ...
    for match in results.matches:
        ...
        temp_profile = Profile(
            ...
            birth_date=pd.to_datetime(
                date.today() - timedelta(days=metadata["age"] * 365)
